...
var iggleCreateForest=function(){
...
this.input.on('pointermove', function (pointer) {
 ...
 this.scope.x=pointer.worldX;
 this.scope.y=pointer.worldY;
 //this.scopeCam.scrollX=pointer.worldX;
 //this.scopeCam.scrollY=pointer.worldY;
 this.scopeCam.x=this.crosshair.x-100;
 this.scopeCam.y=this.crosshair.y-100;
...
this.testBlur=this.time.addEvent({
  delay:10000,
  repeat:-1,
  callback:function(){
