...
gameScene.preload = function () {
  ...
  this.load.atlas(
    "blood1",
    ["assets/sprites/blood/Front_1.png", "assets/sprites/blood/Front_1_n.png"],
    "assets/sprites/blood/Front_1.json"
  );
  this.load.atlas(
    "blood2",
    ["assets/sprites/blood/Front_7.png", "assets/sprites/blood/Front_7_n.png"],
    "assets/sprites/blood/Front_1.json"
  );
  this.load.atlas(
    "blood3",
    ["assets/sprites/blood/Front_9.png", "assets/sprites/blood/Front_9_n.png"],
    "assets/sprites/blood/Front_1.json"
  );
  this.load.atlas(
    "blood4",
    [
      "assets/sprites/blood/Front_11.png",
      "assets/sprites/blood/Front_11_n.png",
    ],
    "assets/sprites/blood/Front_1.json"
  );
  this.load.atlas(
    "blood5",
    [
      "assets/sprites/blood/Front_13.png",
      "assets/sprites/blood/Front_13_n.png",
    ],
    "assets/sprites/blood/Front_1.json"
  );
  ...
  this.load.unityAtlas(
    "squatch2",
    "assets/sprites/squatch/character_idle.png",
    "assets/sprites/squatch/character_idle.png.meta"
  );
...
gameScene.create = function () {
  ...
  this.anims.create({
    key: "squatch2Idle",
    frames: this.anims.generateFrameNames("squatch2", {
      prefix: "idle_",
      start: 0,
      end: 20,
    }),
  ...
  this.anims.create({
    key: "bleed1",
    frames: this.anims.generateFrameNames("blood1", {
      prefix: "bleed_",
      start: 0,
      end: 57,
    }),
  ...
  this.anims.create({
    key: "bleed2",
    frames: this.anims.generateFrameNames("blood2", {
      prefix: "bleed_",
      start: 0,
      end: 57,
    }),
  ...
  this.anims.create({
    key: "bleed3",
    frames: this.anims.generateFrameNames("blood3", {
      prefix: "bleed_",
      start: 0,
      end: 57,
    }),
  ...
  this.anims.create({
    key: "bleed4",
    frames: this.anims.generateFrameNames("blood4", {
      prefix: "bleed_",
      start: 0,
      end: 57,
    }),
  ...
  this.anims.create({
    key: "bleed5",
    frames: this.anims.generateFrameNames("blood5", {
      prefix: "bleed_",
      start: 0,
      end: 57,
    }),
  ...
  this.squatchArm = this.add.sprite(
    this.squatch.x,
    this.squatch.y,
    "squatchRifle",
    "rifle_1"
...
this.textures.get('erased').setDataSource(source);
    ...
    function () {
      ...
      for (var y = 0; y < yCutCount; y++) {
        for (var x = 0; x < xCutCount; x++) {
          ...
          var img = this.add
            .sprite(this.squatch.x, this.squatch.y, "erased")
  ...
  this.theLight = this.lights
    .addLight(this.squatch.x + 100, this.squatch.y, 800)
    .setColor(0x111111)
    .setIntensity(9);
...
gameScene.update = function () {
  if (this.cursors.space.isDown && this.shooting == false) {
    this.squatch.play("squatchHoldSide");
    ...
    this.flash = this.lights
      .addLight(this.muzzleFlash.x, this.muzzleFlash.y, 400)
      .setColor(0xfffff)
      .setIntensity(0);
  ...
  if (this.cursors.left.isDown) {
    this.squatch.flipX = false;
    this.squatch.play("squatchWalkSide");
  }
  if (this.cursors.up.isDown) {
    this.squatch.play("squatchWalkUp");
  }
  if (this.cursors.right.isDown) {
    this.squatch.flipX = true;
    this.squatch.play("squatchHeadShot");
    this.blood.visible = true;
    this.blood.play("bleed");
  }
  if (this.cursors.down.isDown) {
    this.squatch.play("squatchWalk");
  }
