...
this.load.image('cloud1', ['assets/backgrounds/driving/desert/cloud1.png','assets/backgrounds/driving/desert/cloud1_n.png'])
this.load.image('cloud2', ['assets/backgrounds/driving/desert/cloud2.png','assets/backgrounds/driving/desert/cloud2_n.png'])
...
drivingScene.create = function(){
   ...
   for(i=0;i<Phaser.Math.Between(3,15);i++){
     let cloud =this.physics.add.sprite(0, Phaser.Math.Between(0,300),'cloud'+Phaser.Math.Between(1,2));
     ...
     if(Phaser.Math.Between(1,2)==2){cloud.flipX=true;}else{cloud.flipX=false};
...
this.streetLine.tilePositionX+=12;
...
for(i=0;i<numClouds;i++){
  ...
  if(clouds[i].x<-600){
clouds[i].setPosition(2000, Phaser.Math.Between(0,300)).setScale(Math.random()*Math.random());
if(Phaser.Math.Between(1,2)==2){clouds[i].flipX=true;}else{clouds[i].flipX=false};  
